      ...
      {product && (
        <div className="border border-primary-100 rounded-xl p-2 text-neutral-700 space-y-1 cursor-pointer  ">
          ...
          <div className="flex items-center justify-between">
            <p>
              <span className="font-medium text-lg text-primary-300">{product.sp}</span> <span className="line-through text-sm">{product.sp + 0.2 * product.sp}</span>
            </p>

            <div className="flex space-x-2">
              <Link
                href={"/cart"}
                className="rounded-full border border-neutral-300 bg-primary-50 p-2 text-primary-300 cursor-pointer hover:bg-primary-300 hover:text-neutral-50 hover:-translate-y-1 duration-300">
                <ShoppingCart size={18} />
              </Link>

              <Link
                href={"/product/single-product-detail-page"}
                className="rounded-full border border-neutral-300 bg-primary-50 p-2 text-primary-300 cursor-pointer hover:bg-primary-300 hover:text-neutral-50 hover:-translate-y-1 duration-300">
                <EyeIcon size={18} />
              </Link>
            </div>
