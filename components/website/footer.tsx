  ...
  return (
    <footer className="text-gray-500 bg-white py-5 ">
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <div className="max-w-xs">
           <Image src={logo} alt="img" className=" w-32 mx-auto" />
            <p className="leading-relaxed mt-2 ">Premium Clothing Wear Made in Nepal. The true meaning of genuine. Dallu Bijeswori, Kathmandu, Nepal 44600</p>
          </div>
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="max-w-sm flex items-center border rounded-md p-1">
              ...
              />
              <button className="p-2.5 rounded-md text-white bg-primary-300 outline-none shadow-md focus:shadow-none sm:px-5">Subscribe</button>
            </div>
          </form>
        </div>
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">&copy; 2024 dorowears rights reserved.</div>
